...
export default function LogoutButton() {
    ...
    return (
        <OutLineButton onClick={handleLogout} className='ml-auto'>
            <span
                className="text-white font-bold hidden md:inline"
            >
                Logout
            </span>
            < svg width="32" height="32" className='h-6 w-6' viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" >
